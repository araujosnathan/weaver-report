...
//     toastr.success('Uma boa base de qualidade dentro do projeto é representado por uma boa base de testes unitários!','Projeto sem teste unitários',{
...
//     toastr.warning('Seu projeto está sem testes de contrato!','Top Full Width',{
//         "positionClass": "toast-top-full-width",
//         timeOut: 5000,
//         "closeButton": true,
//         "debug": false,
...
//     toastr.warning('Uma Boa estratégia de testes é saber dividir os cenários em cada nível, por isso é importante também realizar testes de contrato!','Projeto sem testes de contrato',{
//         "positionClass": "toast-bottom-full-width",
//         timeOut: 10000,
//         "closeButton": true,
//         "debug": false,
...
$('#toastr-unit-tests-danger-bottom-full-width').on("click", function() {
    toastr.error('Uma boa base de qualidade dentro do projeto é representado por uma boa base de testes unitários!','Projeto sem teste unitários',{
        "positionClass": "toast-bottom-full-width",
        timeOut: 10000,
        "closeButton": true,
        "debug": false,
...
$('#toastr-contract-tests-danger-bottom-full-width').on("click", function() {
    toastr.error('Uma Boa estratégia de testes é saber dividir os cenários em cada nível, por isso é importante também realizar testes de contrato!','Projeto sem testes de contrato',{
        "positionClass": "toast-bottom-full-width",
        timeOut: 10000,
        "closeButton": true,
        "debug": false,
