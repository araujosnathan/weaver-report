...
function get_danger_button_of_contract_test
{
  ...
  BUTTON_CONTRACT_TEST="<button type='button' class='btn btn-danger m-b-10 m-l-5' id='toastr-contract-tests-danger-bottom-full-width'>$CONTRACT_TEST_WARNING_BUTTON</button>"
}
